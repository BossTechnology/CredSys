...
const STAGES: { key: AccreditationStatus; label: string; step: number }[] = [
  ...
  { key: "interview_completed",          label: "Interviewed",    step: 4 },
  { key: "chass1s_shared",               label: "CHASS1S",        step: 5 },
  { key: "implementation_in_progress",   label: "Implementing",   step: 6 },
  { key: "ready_for_verification",       label: "Ready",          step: 7 },
  { key: "verification_in_progress",     label: "Verifying",      step: 8 },
  { key: "accredited",                   label: "Accredited",     step: 9 },
];
