  ...
  return `
    <div style="font-family:'Courier New',monospace;background:#000000;color:#ffffff;padding:32px 24px;max-width:520px;margin:0 auto">
      <div style="margin-bottom:20px">
        <div style="font-size:18px;font-weight:bold;letter-spacing:0.15em;color:#ffffff">STARTUPBOSS.ORG</div>
        <div style="font-size:9px;color:#6B6B6B;margin-top:2px;letter-spacing:0.2em;text-transform:uppercase">GetCRED · Build Trust · Become Unstoppable</div>
      </div>
      ...
      <div style="border-top:1px solid #222222;margin-top:32px;padding-top:16px">
        ...
        <p style="font-size:8px;color:#333333;margin:4px 0 0">
          StartupBoss.org &mdash; Accreditation Platform
        </p>
      </div>
    </div>
  `.trim();
