      ...
      <div className="bg-white border border-cs-200">
        ...
        {total === 0 ? (
          <div className="px-5 py-10 text-center">
            <p className="text-[8px] font-mono text-cs-400">No accelerators found.</p>
          </div>
        ) : (
          <>
            ...
            <div className="divide-y divide-cs-100">
              {(accelerators ?? []).map((acc) => (
                ...
                >
                  <div>
                    <div className="text-[8px] font-semibold">{acc.org_name}</div>
                    <div className="text-[7px] font-mono text-cs-400">{acc.email}</div>
                    <div className="text-[6.5px] font-mono text-cs-300 mt-0.5">Since {fmt(acc.created_at)}</div>
                  </div>
                  <div className="text-[7.5px] font-mono text-cs-500 capitalize">{acc.industry ?? "—"}</div>
                  <div className="text-[7.5px] font-mono text-cs-500">{acc.country ?? "—"}</div>
                  <div>
