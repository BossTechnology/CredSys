      ...
      <div className="bg-white border border-cs-200">
        ...
        {total === 0 ? (
          <div className="px-5 py-10 text-center">
            <p className="text-[8px] font-mono text-cs-400">No credentials issued yet.</p>
          </div>
        ) : (
          <>
              ...
              {(creds ?? []).map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-[7.5px] font-mono text-cs-400">{fmt(c.accredited_at)}</div>
                    <div className={`text-[7.5px] font-mono ${isExpired ? "text-red-500 font-bold" : "text-cs-400"}`}>
                    ...
                    <div>
                      ...
                      {!c.is_active && (
                        <div className="text-[6.5px] font-mono text-cs-400 mt-0.5 uppercase">Inactive</div>
                      )}
                    </div>
                  </div>
                );
