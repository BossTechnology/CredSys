...
export default async function EvaluatorProfilePage() {
  ...
  return (
    <div className="max-w-[600px] mx-auto px-7 py-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Evaluator Profile</h1>
      ...
      <div className="border border-cs-200 bg-white px-4 py-3 flex gap-8 mb-5 text-[7.5px] font-mono">
        ...
        <div>
          <div className="text-cs-400 uppercase tracking-widest mb-0.5">Assignments</div>
          <div className="font-semibold">{assignmentCount ?? 0}</div>
        </div>
        <div>
          <div className="text-cs-400 uppercase tracking-widest mb-0.5">Entries Scored</div>
          <div className="font-semibold">{scoredCount ?? 0}</div>
        </div>
        <div>
